...
<?php
    ...
    if(!empty($_POST)) 
    {
        ...
        $imagePath          = '../shop/images/'. basename($image);
...
<html>
    ...
    <body>
        <h1 class="text-logo"><span class="glyphicon glyphicon-cutlery"></span> Shop Admin <span class="glyphicon glyphicon-cutlery"></span></h1>
         <div class="container admin">
            <div class="row">
                ...
                <div class="col-sm-6 site">
                    <div class="thumbnail">
                        <img width="475px" src="<?php echo '../shop/images/'.$image;?>" alt="...">
